...
H2F h2_ptheta = new H2F("h2_ptheta",100, 75,81 ,100,-5,185);
...
H1F h1_thdiff = new H1F("h1_thdiff", bin_num, -110, 91);
...
H1F h1_ptheta = new H1F("h1_ptheta", bin_num, -1, 181);
                 ...
                 if (e_vz > -25.0 && e_vz < 20.0){
                    ...
                    if (Q2 > 0.05 && Q2 < 0.1 && W > 0.85 && W < 1.05) {            
                        ...
                        for(int itr = 0; itr < num_rtpc_tracks; itr++){
                            ...
                            float ptheta = Math.atan(Math.sqrt(momx*momx+momy*momy)/momz);
                            ptheta *= 180/Math.PI;
                            //ptheta += 90.0;
