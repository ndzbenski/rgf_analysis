...
c_phi.cd(1);
c_phi.draw(h1_phidiffu);
c_phi.draw(h1_phidiff,"same");
...
c_vz.cd(1);
c_vz.draw(h1_vzdiffu);
c_vz.draw(h1_vzdiff,"same");
...
h1_vzdiff.normalize(h1_vzdiff.integral());
h1_phidiff.normalize(h1_phidiff.integral());
