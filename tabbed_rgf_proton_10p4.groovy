...
c_ekin.getCanvas().cd(0);
c_ekin.getCanvas().draw(h1_theta);
c_ekin.getCanvas().cd(1);
c_ekin.getCanvas().draw(h1_phi);
c_ekin.getCanvas().cd(2);
c_ekin.getCanvas().draw(h1_emom);
c_ekin.getCanvas().cd(3);
c_ekin.getCanvas().draw(h1_W);
c_ekin.getCanvas().cd(4);
c_ekin.getCanvas().draw(h1_Q2);
...
c_p1d.getCanvas().cd(0);
c_p1d.getCanvas().draw(h1_tshift);
c_p1d.getCanvas().cd(1);
c_p1d.getCanvas().draw(h1_pmom);
...
ctracknum.getCanvas().cd(0);
ctracknum.getCanvas().draw(h1_numtracks);
ctracknum.getCanvas().cd(1);
ctracknum.getCanvas().draw(h1_numhits);

EmbeddedCanvas c_phi = new EmbeddedCanvas();
//TCanvas c_phi = new TCanvas("c_phi", 1100, 600);
c_phi.getCanvas().initTimer(1000);
c_phi.getCanvas().divide(2,1);
c_phi.getCanvas().cd(0);
c_phi.getCanvas().draw(h2_phie_vs_phip);
c_phi.getCanvas().cd(1);
c_phi.getCanvas().draw(h1_phidiff);

EmbeddedCanvas c_vz = new EmbeddedCanvas();
//TCanvas c_vz = new TCanvas("c_vz", 1100, 600);
c_vz.getCanvas().initTimer(1000);
c_vz.getCanvas().divide(2,1);
c_vz.getCanvas().cd(0);
c_vz.getCanvas().draw(h2_vze_vs_vzp);
c_vz.getCanvas().cd(1);
c_vz.getCanvas().draw(h1_vzdiff);
