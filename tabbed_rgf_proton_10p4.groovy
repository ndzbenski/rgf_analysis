...
c_ekin.getCanvas("e_kinematics").initTimer(1000);
c_ekin.getCanvas("e_kinematics").divide(3,2);
c_ekin.getCanvas("e_kinematics").cd(0);
c_ekin.getCanvas("e_kinematics").draw(h1_theta);
c_ekin.getCanvas("e_kinematics").cd(1);
c_ekin.getCanvas("e_kinematics").draw(h1_phi);
c_ekin.getCanvas("e_kinematics").cd(2);
c_ekin.getCanvas("e_kinematics").draw(h1_emom);
c_ekin.getCanvas("e_kinematics").cd(3);
c_ekin.getCanvas("e_kinematics").draw(h1_W);
c_ekin.getCanvas("e_kinematics").cd(4);
c_ekin.getCanvas("e_kinematics").draw(h1_Q2);
c_ekin.getCanvas("e_kinematics").cd(5);
c_ekin.getCanvas("e_kinematics").draw(h1_xB);

EmbeddedCanvasTabbed c_p1d = new EmbeddedCanvasTabbed("p_kinematics");
//TCanvas c_p1d = new TCanvas("c_p1d", 1200, 600);
c_p1d.getCanvas("p_kinematics").initTimer(1000);
c_p1d.getCanvas("p_kinematics").divide(3,1);
c_p1d.getCanvas("p_kinematics").cd(0);
c_p1d.getCanvas("p_kinematics").draw(h1_tshift);
c_p1d.getCanvas("p_kinematics").cd(1);
c_p1d.getCanvas("p_kinematics").draw(h1_pmom);
c_p1d.getCanvas("p_kinematics").cd(2);
c_p1d.getCanvas("p_kinematics").draw(h1_ptheta);

EmbeddedCanvasTabbed ctracknum = new EmbeddedCanvasTabbed("track_num");
//TCanvas ctracknum = new TCanvas("ctracknum", 1100, 600);
ctracknum.getCanvas("track_num").initTimer(1000);
ctracknum.getCanvas("track_num").divide(2,1);
ctracknum.getCanvas("track_num").cd(0);
ctracknum.getCanvas("track_num").draw(h1_numtracks);
ctracknum.getCanvas("track_num").cd(1);
ctracknum.getCanvas("track_num").draw(h1_numhits);

EmbeddedCanvasTabbed c_phi = new EmbeddedCanvasTabbed("phi");
//TCanvas c_phi = new TCanvas("c_phi", 1100, 600);
c_phi.getCanvas("phi").initTimer(1000);
c_phi.getCanvas("phi").divide(2,1);
c_phi.getCanvas("phi").cd(0);
c_phi.getCanvas("phi").draw(h2_phie_vs_phip);
c_phi.getCanvas("phi").cd(1);
c_phi.getCanvas("phi").draw(h1_phidiff);

EmbeddedCanvasTabbed c_vz = new EmbeddedCanvasTabbed("vz");
//TCanvas c_vz = new TCanvas("c_vz", 1100, 600);
c_vz.getCanvas("vz").initTimer(1000);
c_vz.getCanvas("vz").divide(2,1);
c_vz.getCanvas("vz").cd(0);
c_vz.getCanvas("vz").draw(h2_vze_vs_vzp);
c_vz.getCanvas("vz").cd(1);
c_vz.getCanvas("vz").draw(h1_vzdiff);
